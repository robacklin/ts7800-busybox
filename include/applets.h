...
USE_EPTIME(APPLET(eptime, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_MTDCP(APPLET(mtdcp, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
USE_MV(APPLET(mv, _BB_DIR_BIN, _BB_SUID_NEVER))
USE_MVTIME(APPLET(mvtime, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_PEEKPOKE(APPLET(peekpoke, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
