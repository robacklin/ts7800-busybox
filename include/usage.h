...
#define eptime_trivial_usage \
        "no options"
#define eptime_full_usage \
...
#define mtdcp_trivial_usage \
	"\t%s dest-partition# start-block# bytes dest-file\n" \
	"\t%s src-file dest-partition# start-block#\n"
#define mtdcp_full_usage \
	"\t%s dest-partition# start-block# bytes dest-file\n" \
	"\t%s src-file dest-partition# start-block#\n"
...
#define mvtime_trivial_usage \
        "no options"
#define mvtime_full_usage \
        "This command takes no options\n"
...
#define peekpoke_trivial_usage \
        "BIT_WIDTH ADDRESS [VALUE_TO_WRITE]"
#define peekpoke_full_usage \
        "BIT_WIDTH ADDRESS [VALUE_TO_WRITE]"
#define peekpoke_example_usage \
        "$ peekpoke 8 0x12C00000"
